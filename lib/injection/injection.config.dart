...
import 'package:snowrun/infrastructure/app-info/app_info_repository.dart'
    as _i8;
import 'package:snowrun/infrastructure/hive/hive_provider.dart' as _i6;
...
import 'package:snowrun/utils/record_service.dart' as _i15;
...
_i1.GetIt $initGetIt(
  ...
  gh.singleton<_i14.RecordBloc>(_i14.RecordBloc());
  gh.singleton<_i15.RecordService>(_i15.RecordService());
